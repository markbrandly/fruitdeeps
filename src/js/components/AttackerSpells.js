...
export class AttackerSpells extends Component {
    ...
    render() {
        ...
        var charge = (
            <div>
				<input type='checkbox' id="select-toggle-charge" checked={this.props.player.misc.charge} onChange={this.toggleCharge.bind(this)} /><label for="select-toggle-charge">Charge</label>
			</div>
        )
