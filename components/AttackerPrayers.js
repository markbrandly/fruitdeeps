    ...
    render() {
        ...
        return (
            <div className="highlight-section flex-container-vertical">
				...
				<div>
					<input type="checkbox" name="clear-prayers" id="clear-prayers" checked={this.props.player.prayers.length == 0} onChange={this.handleClearPrayer} /><label htmlFor="clear-prayers">No Prayer</label>
				</div>
			</div>
        )
    }
