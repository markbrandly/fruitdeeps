...
export class AutofillSearchInput extends Component {
    ...
    render() {
        ...
        var ol = (
            <ol className={"auto-complete-results" + ((this.state.searchList.length > 0 && (this.state.isFocused || this.state.isItemFocused)) ? "": " input-hidden-hack")}>
				{results}
			</ol>
        );
        ...
        return (
            <div className="auto-complete-container" >
				...
				{ol}
				{this.state.loading && (<span className='loading-spinner'><img alt="" src="../assets/spinner.svg" style={{height:"1em", width:"auto"}} /></span>)}
