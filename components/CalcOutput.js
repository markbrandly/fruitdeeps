...
export class CalcOutput extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className='flex-container-vertical' style={{    padding: '1em', border: '1px dashed #666'}}>
                {
                ...
                <div>
                    <div className="color-grey" style={{display:"flex", justifyContent:"space-between", alignItems:"center"}}>
                ...
                (<div className='info-badge-holder'>
                  {badges}
                </div>)
              }
            </div>
